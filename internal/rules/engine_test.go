...
func TestBundledDistroProfilesRepresentativeCommands(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "debian readonly allows cat log", profile: "debian-readonly", command: "cat /var/log/jellyfin/jellyfin20260518.log", allowed: true},
		...
		{name: "debian ops allows cat log", profile: "debian-ops", command: "cat /var/log/jellyfin/jellyfin20260518.log", allowed: true},
		...
		{name: "proxmox readonly allows qm list", profile: "proxmox-readonly", command: "qm list", allowed: true},
		{name: "proxmox readonly blocks qm start", profile: "proxmox-readonly", command: "qm start 101", allowed: false},
		{name: "proxmox ops allows qm start", profile: "proxmox-ops", command: "qm start 101", allowed: true},
		{name: "proxmox ops allows pvesh get", profile: "proxmox-ops", command: "pvesh get /nodes", allowed: true},
